...
internal static class LauncherSettings
{
    ...
    public static void Save(LauncherSettingsFile settings)
    {
        ...
        Directory.CreateDirectory(Path.GetDirectoryName(SettingsPath) ?? AppSession.RootDirectory);
        File.WriteAllText(SettingsPath, json);
        Directory.CreateDirectory(Path.GetDirectoryName(TemplateSettingsPath) ?? AppSession.BaseDirectory);
        File.WriteAllText(TemplateSettingsPath, json);
    }
